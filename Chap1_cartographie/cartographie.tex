...
\noindent{\small \textbf{La description des environnements sonores urbains (ESU) est, à l'heure actuelle, réalisée par plusieurs outils dont les plus répandus sont basés sur des modèles d'émissions sonores et de propagation, notamment utilisés pour la cartographie de bruit de trafic. Ces outils possèdent plusieurs limites comme la limitation du nombre de sources considérées ou les approximations générés par ces modèles. Afin d'obtenir une meilleure description des environnements sonores, l'utilisation de mesures et d'enregistrements sonores faits en ville, à travers des réseaux de capteurs fixes et des mesures mobiles, est de plus en plus envisagée. Cette approche permet de considérer l'ESU dans son intégralité en prenant en compte l'ensemble des sources et les effets de l'environnement urbain sur leur propagation. Toutefois, pour utiliser pleinement ces mesures, il reste à savoir estimer les contributions des différentes sources présentes notamment le trafic routier. La méthode et le protocole expérimental mis en place pour ces travaux sont alors exposés.}}
