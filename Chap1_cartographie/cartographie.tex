...
\ml{ca manque de formalisme, ce serais bien de revenir aux equations}
...
\begin{itemize}
\item le nombres de \ml{type de ?? pas clair} sources est, pour l'instant, trop restreint et ne permet pas de considérer l'ensemble des ESU et la perception qu'en ont les citadins,
...
\ml{encore une fois relier a ta problématique}
