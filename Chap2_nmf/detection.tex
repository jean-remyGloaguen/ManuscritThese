...
\begin{table}[ht]
\centering
\caption{Comparaison des 5 méthodes de séparation de sources en vue d'estimer le niveau sonore du trafic routier à partir d'enregistrements monophoniques (\og - \fg{} : pas adpaté, \og + \fg{} : adapté, \og ++ \fg{} : très adapté.}
