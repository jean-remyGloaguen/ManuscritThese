...
\toprule
$\mathbf{f_c}$ (Hz) & $\mathbf{MAE_g}$ & $\mathbf{MAE_{-12}}$ & $\mathbf{MAE_{-6}}$ & $\mathbf{MAE_{0}}$ & $\mathbf{MAE_{6}}$ & $\mathbf{MAE_{12}}$ \\
\midrule
...
\toprule
\multicolumn{1}{c}{$\mathbf{\beta}$} & $\mathbf{w_t}$ & $\mathbf{K}$ & \textbf{représentation} & $\mathbf{t_h}$ & $\mathbf{MAE_g}$ \\ \toprule
