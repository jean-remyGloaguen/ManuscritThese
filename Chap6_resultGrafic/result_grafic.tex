...
L'erreur $MAE_{60}$ par ambiance sonore est ensuite détaillée dans le Tableau \ref{tab:erreur_mae60_amb} selon les combinaisons optimales de chaque NMF : 
